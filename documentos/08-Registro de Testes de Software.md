  ...
  <li> CT-01: Verificar o funcionamento da página Dashboard.<br>
       ...
       <p>Imagem, descrição do teste e resultados</p>
          ...
          <p><i>Resultados dos testes:</i></p>
              <p>Após os testes foi possível observar que a aplicação apresenta o funcionamento correto e dentro do esperado. Na tela de exibição é apresentado os dados quantitativos dos itens cadastrados nas lista (em                     caso de mais de 1 produto idêntico é feito a soma dos seus respectivos valores) e também as listagens de notificações de produtos em quarentena. Todas as notificações de quarentenas são de no máximo 3                      dias ou menos para vencimento, conforme programado e esperado.</p>
  <hr>
